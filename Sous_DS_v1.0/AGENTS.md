...
### Typography
- Primary face: `var(--ds-font-sans)` (Cash Sans)
- Data, labels, timestamps, code: `var(--ds-font-mono)` (Cash Sans Mono) with `font-variant-numeric: tabular-nums`
...
### Color
- One accent per viewport: `--ds-accent-live` (`#E5533C`), and only for temporal/status semantics
